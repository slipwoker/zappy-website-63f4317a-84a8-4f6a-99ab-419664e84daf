  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        successMessage.style.cssText = 'color: green; margin-top: 1rem; padding: 0.75rem; background: #d4edda; border: 1px solid #c3e6cb; border-radius: 4px;';
    ...
    function showError(input, message) {
      ...
      errorDiv.style.cssText = 'color: red; font-size: 0.875rem; margin-top: 0.25rem;';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Nathaniel Horchem uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '63f4317a-84a8-4f6a-99ab-419664e84daf',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '63f4317a-84a8-4f6a-99ab-419664e84daf';
...
;(function(){
  ...
  function _zappyMenuContrastFix(){
    ...
    var menuBg='#0B1220';var menuText='#F7FAFF';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '63f4317a-84a8-4f6a-99ab-419664e84daf';
